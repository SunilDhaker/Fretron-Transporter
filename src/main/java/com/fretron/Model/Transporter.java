...
public class Transporter extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
    ...
    @Deprecated
    public java.util.List<java.lang.String> adminEmail;
    @Deprecated
    public java.util.List<com.fretron.Model.Groups> groups;
    @Deprecated
    ...
    public void put(int field$, java.lang.Object value$) {
        switch (field$) {
            case 0:
                ...
                break;
            case 1:
                adminEmail = (java.util.List<java.lang.String>) value$;
                break;
            case 2:
                groups = (java.util.List<com.fretron.Model.Groups>) value$;
                break;
            case 3:
