...
public class Groups extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public java.util.List<Groups> subgroups;
   ...
   */
  public Groups(java.lang.String groupId, java.util.List<Groups> subgroups, java.lang.String name, java.lang.String admin, java.util.List<java.lang.String> members) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: subgroups = (java.util.List<Groups>)value$; break;
   ...
   */
  public java.util.List<Groups> getSubgroups() {
    return subgroups;
  }
   ...
   * @param value the value to set.
   */
  public void setSubgroups(java.util.List<Groups> value) {
  ...
  public static Groups.Builder newBuilder() {
    return new Groups.Builder();
  }
  
  /** Creates a new Groups RecordBuilder by copying an existing Builder */
  public static Groups.Builder newBuilder(Groups.Builder other) {
    return new Groups.Builder(other);
  }
  
  /** Creates a new Groups RecordBuilder by copying an existing Groups instance */
  public static Groups.Builder newBuilder(Groups other) {
    return new Groups.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Groups>
    ...
    private java.util.List<Groups> subgroups;
    ...
    private Builder(Groups.Builder other) {
      super(other);
    ...
    /** Sets the value of the 'groupId' field */
    public Groups.Builder setGroupId(java.lang.String value) {
    ...
    public Groups.Builder clearGroupId() {
      groupId = null;
    ...
    /** Sets the value of the 'subgroups' field */
    public Groups.Builder setSubgroups(java.util.List<Groups> value) {
    ...
    public Groups.Builder clearSubgroups() {
      subgroups = null;
    ...
    /** Sets the value of the 'name' field */
    public Groups.Builder setName(java.lang.String value) {
    ...
    public Groups.Builder clearName() {
      name = null;
    ...
    /** Sets the value of the 'admin' field */
    public Groups.Builder setAdmin(java.lang.String value) {
    ...
    public Groups.Builder clearAdmin() {
      admin = null;
    ...
    /** Sets the value of the 'members' field */
    public Groups.Builder setMembers(java.util.List<java.lang.String> value) {
    ...
    public Groups.Builder clearMembers() {
      members = null;
    ...
    public Groups build() {
      try {
        ...
        record.subgroups = fieldSetFlags()[1] ? this.subgroups : (java.util.List<Groups>) defaultValue(fields()[1]);
