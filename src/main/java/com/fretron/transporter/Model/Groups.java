...
public class Groups extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public Groups(java.lang.String groupId, java.util.List<com.fretron.transporter.Model.Groups> subgroups, java.lang.String name, java.lang.String admin, java.util.List<java.lang.String> members) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: subgroups = (java.util.List<com.fretron.transporter.Model.Groups>)value$; break;
   ...
   */
  public java.util.List<com.fretron.transporter.Model.Groups> getSubgroups() {
    return subgroups;
  }
   ...
   * @param value the value to set.
   */
  public void setSubgroups(java.util.List<com.fretron.transporter.Model.Groups> value) {
  ...
  public static com.fretron.transporter.Model.Groups.Builder newBuilder() {
    return new com.fretron.transporter.Model.Groups.Builder();
  }
  
  /** Creates a new Groups RecordBuilder by copying an existing Builder */
  public static com.fretron.transporter.Model.Groups.Builder newBuilder(com.fretron.transporter.Model.Groups.Builder other) {
    return new com.fretron.transporter.Model.Groups.Builder(other);
  }
  
  /** Creates a new Groups RecordBuilder by copying an existing Groups instance */
  public static com.fretron.transporter.Model.Groups.Builder newBuilder(com.fretron.transporter.Model.Groups other) {
    return new com.fretron.transporter.Model.Groups.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Groups>
    ...
    private java.util.List<com.fretron.transporter.Model.Groups> subgroups;
    ...
    private Builder() {
      super(com.fretron.transporter.Model.Groups.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.fretron.transporter.Model.Groups.Builder other) {
      super(other);
    ...
    private Builder(com.fretron.transporter.Model.Groups other) {
            super(com.fretron.transporter.Model.Groups.SCHEMA$);
      if (isValidValue(fields()[0], other.groupId)) {
        this.groupId = data().deepCopy(fields()[0].schema(), other.groupId);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'groupId' field */
    public com.fretron.transporter.Model.Groups.Builder setGroupId(java.lang.String value) {
    ...
    public com.fretron.transporter.Model.Groups.Builder clearGroupId() {
      groupId = null;
    ...
    /** Sets the value of the 'subgroups' field */
    public com.fretron.transporter.Model.Groups.Builder setSubgroups(java.util.List<com.fretron.transporter.Model.Groups> value) {
    ...
    public com.fretron.transporter.Model.Groups.Builder clearSubgroups() {
      subgroups = null;
    ...
    /** Sets the value of the 'name' field */
    public com.fretron.transporter.Model.Groups.Builder setName(java.lang.String value) {
    ...
    public com.fretron.transporter.Model.Groups.Builder clearName() {
      name = null;
    ...
    /** Sets the value of the 'admin' field */
    public com.fretron.transporter.Model.Groups.Builder setAdmin(java.lang.String value) {
    ...
    public com.fretron.transporter.Model.Groups.Builder clearAdmin() {
      admin = null;
    ...
    /** Sets the value of the 'members' field */
    public com.fretron.transporter.Model.Groups.Builder setMembers(java.util.List<java.lang.String> value) {
    ...
    public com.fretron.transporter.Model.Groups.Builder clearMembers() {
      members = null;
    ...
    public Groups build() {
      try {
        ...
        record.subgroups = fieldSetFlags()[1] ? this.subgroups : (java.util.List<com.fretron.transporter.Model.Groups>) defaultValue(fields()[1]);
