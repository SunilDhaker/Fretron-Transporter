...
public class FreightLocation extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public com.fretron.transporter.Model.Geofence geofence;
   ...
   */
  public FreightLocation(java.lang.String name, com.fretron.transporter.Model.Geofence geofence, java.util.List<java.lang.String> material) {
    this.name = name;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: geofence = (com.fretron.transporter.Model.Geofence)value$; break;
   ...
   */
  public com.fretron.transporter.Model.Geofence getGeofence() {
    return geofence;
  }
   ...
   * @param value the value to set.
   */
  public void setGeofence(com.fretron.transporter.Model.Geofence value) {
    this.geofence = value;
  }
  ...
  public static com.fretron.transporter.Model.FreightLocation.Builder newBuilder() {
    return new com.fretron.transporter.Model.FreightLocation.Builder();
  }
  
  /** Creates a new FreightLocation RecordBuilder by copying an existing Builder */
  public static com.fretron.transporter.Model.FreightLocation.Builder newBuilder(com.fretron.transporter.Model.FreightLocation.Builder other) {
    return new com.fretron.transporter.Model.FreightLocation.Builder(other);
  }
  
  /** Creates a new FreightLocation RecordBuilder by copying an existing FreightLocation instance */
  public static com.fretron.transporter.Model.FreightLocation.Builder newBuilder(com.fretron.transporter.Model.FreightLocation other) {
    return new com.fretron.transporter.Model.FreightLocation.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<FreightLocation>
    ...
    private com.fretron.transporter.Model.Geofence geofence;
    private java.util.List<java.lang.String> material;

    /** Creates a new Builder */
    private Builder() {
      super(com.fretron.transporter.Model.FreightLocation.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.fretron.transporter.Model.FreightLocation.Builder other) {
      super(other);
    ...
    private Builder(com.fretron.transporter.Model.FreightLocation other) {
            super(com.fretron.transporter.Model.FreightLocation.SCHEMA$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'name' field */
    public com.fretron.transporter.Model.FreightLocation.Builder setName(java.lang.String value) {
    ...
    public com.fretron.transporter.Model.FreightLocation.Builder clearName() {
      name = null;
    ...
    /** Sets the value of the 'geofence' field */
    public com.fretron.transporter.Model.FreightLocation.Builder setGeofence(com.fretron.transporter.Model.Geofence value) {
    ...
    public com.fretron.transporter.Model.FreightLocation.Builder clearGeofence() {
      geofence = null;
    ...
    /** Sets the value of the 'material' field */
    public com.fretron.transporter.Model.FreightLocation.Builder setMaterial(java.util.List<java.lang.String> value) {
    ...
    public com.fretron.transporter.Model.FreightLocation.Builder clearMaterial() {
      material = null;
    ...
    public FreightLocation build() {
      try {
        ...
        record.geofence = fieldSetFlags()[1] ? this.geofence : (com.fretron.transporter.Model.Geofence) defaultValue(fields()[1]);
