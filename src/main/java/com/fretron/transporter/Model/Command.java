...
public class Command extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static Command.Builder newBuilder(Command.Builder other) {
    return new Command.Builder(other);
  }
  
  /** Creates a new Command RecordBuilder by copying an existing Command instance */
  public static Command.Builder newBuilder(Command other) {
    return new Command.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Command>
    ...
    private Builder(Command.Builder other) {
      super(other);
    ...
    /** Sets the value of the 'type' field */
    public Command.Builder setType(java.lang.String value) {
    ...
    /** Sets the value of the 'data' field */
    public Command.Builder setData(java.nio.ByteBuffer value) {
    ...
    public Command.Builder clearData() {
      data = null;
    ...
    /** Sets the value of the 'id' field */
    public Command.Builder setId(java.lang.String value) {
    ...
    /** Sets the value of the 'statusCode' field */
    public Command.Builder setStatusCode(java.lang.Integer value) {
    ...
    public Command.Builder clearStatusCode() {
      statusCode = null;
    ...
    /** Sets the value of the 'errorMessage' field */
    public Command.Builder setErrorMessage(java.lang.String value) {
    ...
    public Command.Builder clearErrorMessage() {
      errorMessage = null;
    ...
    /** Sets the value of the 'startTime' field */
    public Command.Builder setStartTime(java.lang.Long value) {
    ...
    public Command.Builder clearStartTime() {
      startTime = null;
    ...
    /** Sets the value of the 'processTime' field */
    public Command.Builder setProcessTime(java.lang.Long value) {
    ...
    public Command.Builder clearProcessTime() {
      processTime = null;
