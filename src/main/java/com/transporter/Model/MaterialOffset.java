...
public class MaterialOffset extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static com.transporter.Model.MaterialOffset.Builder newBuilder() {
    return new com.transporter.Model.MaterialOffset.Builder();
  }
  
  /** Creates a new MaterialOffset RecordBuilder by copying an existing Builder */
  public static com.transporter.Model.MaterialOffset.Builder newBuilder(com.transporter.Model.MaterialOffset.Builder other) {
    return new com.transporter.Model.MaterialOffset.Builder(other);
  }
  
  /** Creates a new MaterialOffset RecordBuilder by copying an existing MaterialOffset instance */
  public static com.transporter.Model.MaterialOffset.Builder newBuilder(com.transporter.Model.MaterialOffset other) {
    return new com.transporter.Model.MaterialOffset.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<MaterialOffset>
    ...
    private Builder() {
      super(com.transporter.Model.MaterialOffset.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.transporter.Model.MaterialOffset.Builder other) {
      super(other);
    ...
    private Builder(com.transporter.Model.MaterialOffset other) {
            super(com.transporter.Model.MaterialOffset.SCHEMA$);
      if (isValidValue(fields()[0], other.material)) {
        this.material = data().deepCopy(fields()[0].schema(), other.material);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'material' field */
    public com.transporter.Model.MaterialOffset.Builder setMaterial(java.lang.String value) {
    ...
    public com.transporter.Model.MaterialOffset.Builder clearMaterial() {
      material = null;
    ...
    /** Sets the value of the 'materialOffset' field */
    public com.transporter.Model.MaterialOffset.Builder setMaterialOffset(int value) {
    ...
    public com.transporter.Model.MaterialOffset.Builder clearMaterialOffset() {
