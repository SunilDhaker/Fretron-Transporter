...
public class Location extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static com.transporter.Model.Location.Builder newBuilder() {
    return new com.transporter.Model.Location.Builder();
  }
  
  /** Creates a new Location RecordBuilder by copying an existing Builder */
  public static com.transporter.Model.Location.Builder newBuilder(com.transporter.Model.Location.Builder other) {
    return new com.transporter.Model.Location.Builder(other);
  }
  
  /** Creates a new Location RecordBuilder by copying an existing Location instance */
  public static com.transporter.Model.Location.Builder newBuilder(com.transporter.Model.Location other) {
    return new com.transporter.Model.Location.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Location>
    ...
    private Builder() {
      super(com.transporter.Model.Location.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.transporter.Model.Location.Builder other) {
      super(other);
    ...
    private Builder(com.transporter.Model.Location other) {
            super(com.transporter.Model.Location.SCHEMA$);
      if (isValidValue(fields()[0], other.latitude)) {
        this.latitude = data().deepCopy(fields()[0].schema(), other.latitude);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'latitude' field */
    public com.transporter.Model.Location.Builder setLatitude(double value) {
    ...
    public com.transporter.Model.Location.Builder clearLatitude() {
    ...
    /** Sets the value of the 'longitude' field */
    public com.transporter.Model.Location.Builder setLongitude(double value) {
    ...
    public com.transporter.Model.Location.Builder clearLongitude() {
