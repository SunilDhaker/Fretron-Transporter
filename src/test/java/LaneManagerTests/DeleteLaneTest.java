...
public class DeleteLaneTest {
    /*
test to delete lane if uuid matches
(else)
test will failed if uuid doesn't exist and also failed if lane was already deleted
 ...
 */
    ...
    public void startTest() throws InterruptedException {
        ...
        Lane existingLane = new Lane("222","123","type",null,null,90098.7878,"polymer",null,null,null,false);
        Lane lane = new Lane("222","123","type",null,null,90098.7878,"polymer",null,null,null,false);

        Producer<String,Command> producer = HelperClass.getProducer(bootstrapServer,schemaRegistry);

        new Thread(()->{
            Command command = new Command("lane.create.success",
                    ByteBuffer.wrap(laneSerde.serializer().serialize(laneTopic,existingLane)),
            ...
            Command command1 = new Command("lane.delete.command",
