...
public class UpdateLaneTest {
    /*
    test to update lane if uuid matches
    (else)
    test will failed if uuid doesn't exist and if lane was already deleted
     */
    @ClassRule
    ...
    public void startTest() throws InterruptedException {
        ...
        new Thread(()->{
            ...
            Command command1 = new Command("lane.update.command",
