 ...
 */
public class TransporterUpdateCase {
    ...
    @Test
    public void testTransporterUpdate() throws Exception {
...
//update
            //adminEmailList.add("EE@gmail.com");
            ...
            commandUpdate.setType("transporter.update.command");
        ...
        assert (AssertClass.assertTestActualData(actual,"transporter.updated",2));
    }
