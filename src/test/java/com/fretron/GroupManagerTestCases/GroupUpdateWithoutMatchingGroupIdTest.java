...
public class GroupUpdateWithoutMatchingGroupIdTest {
    /*
   Test of failed updation of group if  groupid   donot match
    */
    @ClassRule
    ...
    public void startTest() throws InterruptedException {
        ...
        Groups updateGroup=new Groups(null,"102",null,"fretron1",list,null);
