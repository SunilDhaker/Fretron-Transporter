...
public class GroupDeleteWithGroupIdTest {

    /*
   Test of success deletion of group if group id  match
    */
    @ClassRule
    ...
    public void startTest() throws InterruptedException {
        ...
        Groups deleteGroup=new Groups(null,"101",null,null,null,null);
        ...
        new Thread(()-> {
            ...
            Command command = new Command( "group.delete.command",
                    ByteBuffer.wrap(groupSerde.serializer().serialize(groupTopic,deleteGroup)),
                    UUID.randomUUID().toString(),
                    200,
                    null,
                    12345678902L,
