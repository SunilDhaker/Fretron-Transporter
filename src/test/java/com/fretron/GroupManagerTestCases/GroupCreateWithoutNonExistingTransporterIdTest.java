...
public class GroupCreateWithoutNonExistingTransporterIdTest {
    ...
    */
    ...
    public void startTest() throws InterruptedException {
        ...
        Groups groups=new Groups("101",null,null,"fretron",getAdmin(),null);
        ...
        List<Command> actual =  IntegrationTestUtils.waitUntilMinValuesRecordsReceived(HelperClass.getConsumerProps("my-group-test" , CLUSTER) ,commandResultTopic,2, 120000);
