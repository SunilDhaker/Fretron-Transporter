...
public class UserUpdateCase2 {
    /*
  User got updated if group id provided is null or group id provided is not null

  this test case got failed if group id provided doesn't match anyone.
*/
    @ClassRule
    ...
    public void startTest() throws InterruptedException {
        ...
        User user=new User(null,"abc","xyz@gmail.com","1234567890","123","001",false);
